    ...
    <div className="ProjectDetails">
      ...
      <div className="ProjectDetails__main">
        ...
        <div className="ProjectDetails__bottom-bar">
          {nextProject ? (
            <Navigation path={`/projects/approved-projects/${nextProject.pk}`} text={nextProject.title} type="right" />
          ) : (
            <Navigation path={`/projects/rules`} text="Rules and Guidelines" type="right" />
          )}
        </div>
      </div>
    </div>
